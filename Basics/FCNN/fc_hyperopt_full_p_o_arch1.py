...
space = {
    ...
    "n0": hp.quniform("n0", 5, 80, 1),
    "n1": hp.quniform("n1", 5, 50, 1), #5, 80, 1
    "n2": hp.quniform("n2", 5, 50, 1),
    "n3": hp.quniform("n3", 5, 50, 1),
    "n4": hp.quniform("n4", 5, 50, 1),
    "n5": hp.quniform("n5", 5, 50, 1),
...
losses = train_model(model, train_loader, optimizer, criterion, epochs=20)
...
def full_evaluation(model, loader, name, save_thresholds=False):
...
full_evaluation(model, test_loader, "test", save_thresholds=True)
